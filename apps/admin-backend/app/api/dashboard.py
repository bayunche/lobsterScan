...
LLM_KEYS = ["ANTHROPIC_API_KEY", "MINIMAX_API_KEY", "QWEN_API_KEY", "GLM_API_KEY", "OPENAI_API_KEY", "DEEPSEEK_API_KEY"]
VIDEO_KEYS = ["HEYGEN_API_KEY", "MINIMAX_API_KEY", "ELEVENLABS_API_KEY", "KLING_ACCESS_KEY_ID"]
